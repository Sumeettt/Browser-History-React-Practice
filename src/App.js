...
import './App.css'
import EachHistoryItem from './Components/EachHistoryItem'
...
class App extends Component {
  ...
  onDeleting = id => {
    ...
    const filteredHistoryList = initialHistory.filter(
      eachHistory => eachHistory.id !== id,
    )

    this.setState({
      initialHistory: filteredHistoryList,
    })
  }
  ...
  render() {
    ...
    const searchResult = initialHistory.filter(eachHistory =>
